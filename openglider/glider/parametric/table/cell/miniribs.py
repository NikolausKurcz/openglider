...
class MiniRibDTO(DTO):
    ...
    back_cut: Percentage
    TrailingEdgeCut: Length | Percentage
    material_code: str

    def get_object(self) -> Any:
        return MiniRib(yvalue=self.y_value.si, front_cut=self.front_cut.si, back_cut=self.back_cut.si, trailing_edge_cut=self.TrailingEdgeCut, material_code=self.material_code)
